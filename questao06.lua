...
local group = self.view
        ...
        bg = display.newImage( "images/questao06/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music6.mp3" )
        ...
        quest = display.newImage( "images/questao06/desafio.png" )
        ...
        questa = display.newImage( "images/questao06/a.png" )
        ...
        questb = display.newImage( "images/questao06/b.png" )
        ...
        questc = display.newImage( "images/questao06/c.png" )
        ...
        questd = display.newImage( "images/questao06/d.png" )
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao06", {effect = "slideUp"})
