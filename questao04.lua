...
local group = self.view
        ...
        bg = audio.loadStream( "sounds/questoes/music4.mp3" )
        ...
        quest = display.newImage( "images/questao04/desafio.png" )
        ...
        questa = display.newImage( "images/questao04/a.png" )
        questa.x = display.contentWidth/2 - 80
        questa.y = display.contentHeight/2 + 80
        questa.xScale = 0.9
        questa.yScale = 0.9
        group:insert(questa)

        questb = display.newImage( "images/questao04/b.png" )
        ...
        questc = display.newImage( "images/questao04/c.png" )
        questc.x = display.contentWidth/2 + 95
        questc.y = display.contentHeight/2 + 80
        questc.xScale = 0.9
        questc.yScale = 0.9
        group:insert(questc)

        questd = display.newImage( "images/questao04/d.png" )
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao04", {effect = "slideUp"})
