...
local group = self.view
        ...
        bg = display.newImage( "images/questao07/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music7.mp3" )
        ...
        quest = display.newImage( "images/questao07/desafio.png" )
        ...
        questa = display.newImage( "images/questao07/a.png" )
        ...
        questb = display.newImage( "images/questao07/b.png" )
        ...
        questc = display.newImage( "images/questao07/c.png" )
        ...
        questd = display.newImage( "images/questao07/d.png" )
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao07", {effect = "slideUp"})
