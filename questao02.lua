...
local group = self.view
        ...
        bg = display.newImage( "images/questao02/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music2.mp3" )
        ...
        quest = display.newImage( "images/questao02/desafio.png" )
        ...
        questa = display.newImage( "images/questao02/a.png" )
        questa.x = display.contentWidth/2 - 90
        questa.y = display.contentHeight/2 + 70
        questa.xScale = 0.9
        questa.yScale = 0.9
        group:insert(questa)

        questb = display.newImage( "images/questao02/b.png" )
        questb.x = display.contentWidth/2 - 93
        questb.y = display.contentHeight/2 + 180
        questb.xScale = 0.9
        questb.yScale = 0.9
        group:insert(questb)

        questc = display.newImage( "images/questao02/c.png" )
        questc.x = display.contentWidth/2 + 105
        questc.y = display.contentHeight/2 + 70
        questc.xScale = 0.9
        questc.yScale = 0.9
        group:insert(questc)

        questd = display.newImage( "images/questao02/d.png" )
        questd.x = display.contentWidth/2 + 115
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao02", {effect = "slideUp"})
    ...
    function quest01( )
        ...
        function fim()
            ...
            storyboard.gotoScene("3quest", {effect = "slideLeft"})
