...
local group = self.view
        ...
        bg = display.newImage( "images/questao08/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music8.mp3" )
        ...
        quest = display.newImage( "images/questao08/desafio.png" )
        quest.x = display.contentWidth/2 
        quest.y = display.contentHeight/2 - 80
        quest.xScale = 0.9
        quest.yScale = 0.9
        group:insert(quest)

        questa = display.newImage( "images/questao08/a.png" )
        questa.x = display.contentWidth/2 - 110
        questa.y = display.contentHeight/2 + 80
        questa.xScale = 0.9
        questa.yScale = 0.9
        group:insert(questa)

        questb = display.newImage( "images/questao08/b.png" )
        questb.x = display.contentWidth/2 - 108
        questb.y = display.contentHeight/2 + 190
        questb.xScale = 0.9
        questb.yScale = 0.9
        group:insert(questb)

        questc = display.newImage( "images/questao08/c.png" )
        questc.x = display.contentWidth/2 + 110
        questc.y = display.contentHeight/2 + 80
        questc.xScale = 0.9
        questc.yScale = 0.9
        group:insert(questc)

        questd = display.newImage( "images/questao08/d.png" )
        questd.x = display.contentWidth/2 + 110
        questd.y = display.contentHeight/2 + 190
        questd.xScale = 0.9
        questd.yScale = 0.9
        group:insert(questd)
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao08", {effect = "slideUp"})
