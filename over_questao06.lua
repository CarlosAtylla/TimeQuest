...
local group = self.view
    ...
    bg = display.newImage( "images/gameover/questao06/background-menu.jpg" )
    ...
    logo = display.newImage( "images/gameover/questao06/gameover.png" )
    logo.x = display.contentWidth/2 - 5
    logo.y = display.contentHeight/2 - 200
    group:insert(logo)

    loser = display.newImage( "images/gameover/questao06/loser.png" )
    ...
    acertos = display.newImage( "images/gameover/questao06/acertou.png" )
    acertos.x = display.contentWidth/2 + 15
    acertos.y = display.contentHeight/2 - 120
    group:insert(acertos)

    --[[menu = display.newImage( "images/gameover/questao06/menu.png" )
