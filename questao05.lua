...
local group = self.view
        ...
        bg = display.newImage( "images/questao05/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music5.mp3" )
        ...
        quest = display.newImage( "images/questao05/desafio.png" )
        quest.x = display.contentWidth/2 
        quest.y = display.contentHeight/2 - 70
        quest.xScale = 1.0
        quest.yScale = 1.0
        group:insert(quest)

        questa = display.newImage( "images/questao05/a.png" )
        ...
        questb = display.newImage( "images/questao05/b.png" )
        questb.x = display.contentWidth/2 - 113
        questb.y = display.contentHeight/2 + 190
        questb.xScale = 0.9
        questb.yScale = 0.9
        group:insert(questb)

        questc = display.newImage( "images/questao05/c.png" )
        questc.x = display.contentWidth/2 + 120
        questc.y = display.contentHeight/2 + 80
        questc.xScale = 0.9
        questc.yScale = 0.9
        group:insert(questc)

        questd = display.newImage( "images/questao05/d.png" )
        questd.x = display.contentWidth/2 + 120
        ...
        function timerDown()
            ...
            if(number == 0)then
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao05", {effect = "slideUp"})
