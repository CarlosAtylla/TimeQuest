...
local group = self.view
 ...
 --Imagem de fundo e posições x e y
    ...
    simbol = display.newImage( "images/questao01/interrogacao.png" )
    ...
    logoquest = display.newImage( "images/questao01/logo-quest.png" )
    logoquest.x = display.contentWidth/2
    logoquest.y = display.contentHeight/2 - 180
    logoquest.alpha = -1
    group:insert(logoquest)

    --[[aviso = display.newImage( "images/questao01/aviso.png" )
    aviso.x = display.contentWidth/2 + 5
    aviso.y = display.contentHeight/2 + 180
    aviso.xScale = 0.8
    aviso.yScale = 0.8
    group:insert(aviso)]]
    ...
    function sair( )
        ...
        --display.remove( aviso )
        transition.cancel( logoquest )
        storyboard.gotoScene("questao01")
