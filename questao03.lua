...
local group = self.view
        ...
        bg = display.newImage( "images/questao03/background-menu.jpg" )
        bg.x = display.contentWidth/2
        bg.y = display.contentHeight/2
        group:insert(bg)

        bg = audio.loadStream( "sounds/questoes/music3.mp3" )
        ...
        quest = display.newImage( "images/questao03/desafio.png" )
        quest.x = display.contentWidth/2 + 2
        quest.y = display.contentHeight/2 - 130
        quest.xScale = 0.9
        quest.yScale = 0.9
        group:insert(quest)

        questa = display.newImage( "images/questao03/a.png" )
        questa.x = display.contentWidth/2 - 90
        questa.y = display.contentHeight/2 - 30
        group:insert(questa)

        questb = display.newImage( "images/questao03/b.png" )
        questb.x = display.contentWidth/2 - 90
        questb.y = display.contentHeight/2 + 170
        group:insert(questb)

        questc = display.newImage( "images/questao03/c.png" )
        questc.x = display.contentWidth/2 + 90
        questc.y = display.contentHeight/2 - 30
        group:insert(questc)

        questd = display.newImage( "images/questao03/d.png" )
        questd.x = display.contentWidth/2 + 90
        questd.y = display.contentHeight/2 + 170
        group:insert(questd)

        queste = display.newImage( "images/questao03/e.png" )
        queste.x = display.contentWidth/2
        queste.y = display.contentHeight/2 + 70
        group:insert(queste)
        ...
        function timerDown()
            ...
            if(number == 0)then
                ...
                queste:removeEventListener( "tap", quest05 )
              ...
              function fim1()
                  ...
                  storyboard.gotoScene("over_questao03", {effect = "slideUp"})
...
function scene:enterScene( event )
    ...
    queste:addEventListener( "tap", quest05 )
